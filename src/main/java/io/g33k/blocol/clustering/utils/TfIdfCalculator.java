...
public class TfIdfCalculator {
	...
	public HashMap<String, TfIdfValuePair> getTfIdfVectorMap(List<String> doc1,
			List<String> doc2, List<List<String>> documents) {

		TfIdfCalculator calculator = this;

		HashMap<String, TfIdfValuePair> map = new HashMap<String, TfIdfValuePair>(
				doc1.size());
