...
package io.g33k.blocol.clustering.hac;
...
public class DefaultClusteringAlgorithm implements ClusteringAlgorithm {
	...
	private void checkArguments(double[][] distances, String[] clusterNames,
		...
		int uniqueCount = new HashSet<String>(Arrays.asList(clusterNames))
				.size();
	...
	@Override
	public Cluster performWeightedClustering(double[][] distances,
			String[] clusterNames, double[] weights,
			LinkageStrategy linkageStrategy) {
